...
test_that("gran_convert output for unknown temporal granularity(s) is error", {
  expect_error(gran_convert("lightyear", "hour"),
               "granularity lightyear and hour both should
               be one of second, minute, qhour, hhour, hour,
               day, week, fortnight, month, quarter, semester, year")
})
