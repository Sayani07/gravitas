...
#' .data %>% histogram_distance(
#'   gran1 = "wknd_wday", gran2 = "hour_day",
#'   response = "general_supply_kwh"
#' )
#' .data %>% histogram_distance(
...
histogram_distance <- function(.data = NULL,
  ...
  new_distvector %>% ggplot2::ggplot(ggplot2::aes(x = freqx)) +
    ggplot2::geom_histogram(ggplot2::aes(y = ..density..)) +
    ggplot2::facet_grid(~newds) +
    ggplot2::xlab("pairwise distances") +
