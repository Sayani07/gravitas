...
(1) which patterns are present in these households?
(2) How strong are the patterns, are they significant enough to be investigated?
(3) Are some houses similar in few periodic patterns but different in others?

We answer these questions using the package.

# Show for one id and then say similarly we need to find for other ids using the code below
