...
Area quantile plots are drawn across hours of the day faceted by weekend/weekday. The black line represents the median, whereas the orange and green represent the area between the 25th and 75th percentile and between 10th and 90th percentile respectively. 
For this household, median energy consumption for the early morning hours is extremely high for weekends compared to weekdays. The energy behavior is skewed to the left, where the 10th and 25th percentile are very close to each other in both weekend/weekday.
