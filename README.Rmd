...
gravitas comes with an interactive webpage, which lets you interactively go through the different functionalities of this package. To try it, simply use gravitas::run_app().
